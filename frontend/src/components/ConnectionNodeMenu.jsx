  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center justify-between px-2">
        <div className="text-[11px] font-light uppercase tracking-[0.22em] text-white/35">{t('connectionMenu.title')}</div>
        <button
          type="button"
          onClick={onClose}
      ...
      {groups.length > 0 ? (
        ...
        <div className="px-3 py-5 text-center text-sm font-light text-white/25">{t('connectionMenu.noCompatible')}</div>
      )}
    </div>
  );
}
